...
return [
    ...
    */
    ...
    'unique'               => ':attribute قبلا ثبت گردیده و قابل ویرایش نمی باشد',
    ...
    */
    ...
    'attributes'           => [
        ...
        'abbreviation'          => 'نامک انگلیسی',
        'name_co'               => 'نام شرکت',
        'profile_image'         => 'تصویر پرفایل',
        'codemelli_image'       => 'تصویر کارت ملی',
        'ostan'                 => 'استان',
        'shahrestan'            => 'شهرستان',
        'shahr'                 => 'شهر',
        'whatsapp_number'       => 'شماره واتساپ',
        'fluency_english'       => 'تسلط به انگلیسی',
        'postal_code'           => 'کدپستی',
        'products'              => 'محصولات',
        'amount'                => 'مبلغ',
        'ref_id'                => 'کد پیگیری',
        'card_bank'             => 'کارت بانکی'
    ],
